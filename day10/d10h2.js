//Exercise Name : Check Prime
// checkPrime.md
// Create a function 'checkPrime' that checks if the given number is prime or not and returns 
//true/false accordingly. For Example:

// To check if a number is prime or not , we start from 2 and go uptil one less that number 
//and check if its modulus is equal to zero or not.
