// Exercise 1: Snail Goes Up the Stairs
// A snail goes up the stairs. Every step, he must go up the step, then go across to the 
//next step. He wants to reach the top of the tower.
