//// Print the names of top 5 movies from the list given below. Ranking of movies is 
//decided by their rating (`vote_average`)
let movies = [
    {
      adult: false,
...
let sortMovies = movies.sort(compareMovies);
// console.log(sortMovies);
let result =[];
let count =0;
for(let i = sortMovies.length-1; i > 0; i--){
    count++;
        result. push(sortMovies[i].title);
    if (count === 5){
        break;
    }
}
